...
const InviteLink = ({ code }: { code: string }) => {
  ...
  return (
    <button
      className="mx-auto flex w-full items-center justify-center gap-2 rounded-xl border-2 border-indigo-600 p-8 text-sm underline-offset-2 hover:underline sm:w-auto md:text-xl"
      onClick={onClick}
    >
      {link}
